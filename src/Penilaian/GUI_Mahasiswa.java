...
public class GUI_Mahasiswa extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtNim.getAccessibleContext().setAccessibleName("txtNim");
        txtNama.getAccessibleContext().setAccessibleName("txtNama");
        txtProdi.getAccessibleContext().setAccessibleName("txtProdi");
        txtAng.getAccessibleContext().setAccessibleName("txtAng");
        btnSimpan.getAccessibleContext().setAccessibleName("btnKTM");
