...
public class GUI_Karyawan extends javax.swing.JFrame {
    ...
    private void pLemburActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pLemburActionPerformed
        ...
        if (pLembur.getSelectedIndex()== 0){
            txtArea.setText (Integer.toString(Lm.HitungA()));
        } else if (pLembur.getSelectedIndex()== 1){
            txtArea.setText (Integer.toString(Lm.HitungB()));
        } else if (pLembur.getSelectedIndex()== 2){
            txtArea.setText (Integer.toString(Lm.HitungC()));
        } else {
            txtArea.setText (Integer.toString(Lm.HitungD()));
        }
    ...
    private void btnProsesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProsesActionPerformed
        ...
        if(pCentang.isSelected()){
            if (pShif.getSelectedIndex()==0){
                ...
                if (pLembur.getSelectedIndex()== 0){
                    txtArea.append("\nTotal Gaji : Rp"+Lm.HitungA()+" PerBulan");
                } else if (pLembur.getSelectedIndex()== 1){
                    txtArea.append("\nTotal Gaji : Rp"+Lm.HitungB()+" PerBulan");
                } else if (pLembur.getSelectedIndex()== 2){
                    txtArea.append("\nTotal Gaji : Rp"+Lm.HitungC()+" PerBulan");
                } else {
                    txtArea.append("\nGaji Lembur: Rp"+Lm.HitungD()+" PerBulan");
                }
            } else {
